...
app.get('/iam/oauth2/customers/authorize', oauth2.authorize);
app.post('/iam/oauth2/customers/authorize', oauth2.authorize);
app.post('/iam/oauth2/customers/access_token', oauth2.token);
